...
<body>
	...
	<div align="center">
		...
		<html:form action="/StatusChangeAction" styleClass="generic-frm">
			<table>
				<tr>
				...
				<tr>
				<tr>
					<td><bean:message key="label.status.choice" /></td>
			...
			<html:hidden property="postID"
				value="<%=Integer.toString(pb.getPostID())%>" />

			<html:submit>
				<bean:message key="submit.change.status" />
			</html:submit>
		</html:form>
		<br>

		<h3>
			<a href = "../PostManagerAction.do"><bean:message key="label.link.backToPostManager" /></a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href = "../RequestNotificationAction.do"><bean:message key="label.link.backToRequestManager" /></a>
		</h3>
